...
// Refresh and Delete the list
// When click on refresh SVG
function refreshList() {
	document.querySelectorAll('.items').forEach(function(a) { a.remove() }) }

// Delete an Item
// When click on Trash SVG
